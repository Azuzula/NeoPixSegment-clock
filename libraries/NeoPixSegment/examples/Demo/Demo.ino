...
#define DUBUG 1 /* 0 = Dubug in Serial monitor is disabled, 1 = Dubug in Serial monitor is enabled */
...
void setup() {
   ...
   */
  NP_Segment.Init(PIN, LEDS_PER_SEGMENT, DISPLAY_FORMAR, DUBUG); /* Display initialization*/
